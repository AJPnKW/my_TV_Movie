...
Log 'Media playback QA v0.6.6'
$script=Join-Path $RepoRoot 'tools\media_renamer\media_playback_qa.py'
Run-Python @('-m','py_compile',$script) 'Compile media_playback_qa.py'
Run-Python @($script,'scan','--repo',$RepoRoot,'--media-root',$MediaRoot) 'Scan media playback QA'
