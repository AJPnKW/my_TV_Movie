...
def _check_field(entity_type: str, entity: Dict[str, Any], context: Dict[str, Any], field: Dict[str, Any], issues: List[str], warnings: List[str], counts: Counter) -> None:
...
def _check_entity(entity_type: str, entity: Dict[str, Any], context: Dict[str, Any], issues: List[str], warnings: List[str], counts: Counter) -> None:
    for field in EXPECTED_FIELDS[entity_type]:
        _check_field(entity_type, entity, context, field, issues, warnings, counts)
    ...
    for show in data.get("shows", []) or []:
        ...
        for season in show.get("seasons", []) or []:
            ...
            for episode in season.get("episodes", []) or []:
                ...
                _check_entity("episode", episode, episode_context, issues, warnings, counts)
