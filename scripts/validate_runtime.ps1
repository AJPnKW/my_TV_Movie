...
foreach ($needle in @(
    ...
    'MC-2026-09-16.1',
    'Inputs Editor Publish Version-Control Standard',
    'Current version MC-2026-09-16.1',
    ...
    '<tr><td>2026-09-16</td><td>MC-2026-09-16.1</td>',
    'Freshness rule',
    ...
    'show_activity_window_days = 183',
    'movie_release_window_days = 183',
    'movie_release_lookahead_days = 30',
