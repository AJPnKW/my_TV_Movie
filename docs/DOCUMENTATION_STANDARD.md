...
| local server launch | `tools/run_local_servers.bat` | `docs/README.md`, `docs/ARCHITECTURE.md` | root `run_server.bat` delegates to the canonical launcher | old `app.py`/port `8811` root launch path | `powershell -ExecutionPolicy Bypass -File scripts/validate_runtime.ps1` |
